...
Description
    Calculates and writes the second invariant of the 2D velocity gradient tensor.
    The gradients in Z direction are set to 0. This allows comparison with planar
    data, e.g. from PIV
