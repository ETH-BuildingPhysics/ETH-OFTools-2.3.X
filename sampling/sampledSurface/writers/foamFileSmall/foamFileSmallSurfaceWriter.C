...
#include "foamFileSmallSurfaceWriter.H"
...
namespace Foam
{
    makeSurfaceWriterType(foamFileSmallSurfaceWriter);
...
template<class Type>
void Foam::foamFileSmallSurfaceWriter::writeTemplate
(
...
Foam::foamFileSmallSurfaceWriter::foamFileSmallSurfaceWriter()
:
    surfaceWriter()
{}
...
void Foam::foamFileSmallSurfaceWriter::write
(
    const fileName& outputDir,
    const fileName& surfaceName,
    const pointField& points,
...
defineSurfaceWriterWriteFields(Foam::foamFileSmallSurfaceWriter);
